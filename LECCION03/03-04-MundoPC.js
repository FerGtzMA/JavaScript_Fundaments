...
class Monitor{
    ...
    toString(){
        return `Monitor: [idMonitor: ${this._idMonitor}, marca: ${this._marca}, tamaño: ${this._tamanio} pul]`;
    }
}
...
let computadora1 = new Computadora("FeRpc", monitor1, raton1, teclado1);
console.log(computadora1.toString());

let computadora2 = new Computadora("FeRpc", monitor1, raton1, teclado1);
